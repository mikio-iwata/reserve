...
## 最終件数
- A_表示・レスポンシブ: 合格 74 / 保留 1 / 未実施 94 / 対象外 188
- C_機能回帰: 合格 19 / 保留 6 / 不合格 0 / 未実施 8
- 不具合一覧: 対応済み 4 / データ不足 1 / 本番確認待ち 1
...
## 不合格または保留の一覧
- A-001: 未実施 / 実ブラウザで該当画面・該当項目を手順通り完全検証できていないため未実施。前回の静的確認を合格扱いするのは不適切と判断し訂正。
- A-002: 未実施 / 実ブラウザで該当画面・該当項目を手順通り完全検証できていないため未実施。前回の静的確認を合格扱いするのは不適切と判断し訂正。
- A-003: 未実施 / 実ブラウザで該当画面・該当項目を手順通り完全検証できていないため未実施。前回の静的確認を合格扱いするのは不適切と判断し訂正。 751～900px帯は未検証のため、別途確認が必要。
- A-004: 未実施 / 実ブラウザで該当画面・該当項目を手順通り完全検証できていないため未実施。前回の静的確認を合格扱いするのは不適切と判断し訂正。
- A-005: 未実施 / 実ブラウザで該当画面・該当項目を手順通り完全検証できていないため未実施。前回の静的確認を合格扱いするのは不適切と判断し訂正。
- A-006: 未実施 / 実ブラウザで該当画面・該当項目を手順通り完全検証できていないため未実施。前回の静的確認を合格扱いするのは不適切と判断し訂正。
- A-007: 未実施 / 実ブラウザで該当画面・該当項目を手順通り完全検証できていないため未実施。前回の静的確認を合格扱いするのは不適切と判断し訂正。
- A-008: 未実施 / 実ブラウザで該当画面・該当項目を手順通り完全検証できていないため未実施。前回の静的確認を合格扱いするのは不適切と判断し訂正。
- A-009: 未実施 / ソース基準: CodePage=932 / Session.CodePage=932 / meta charset=shift_jis あり。表示確認は要ログインのため未実施。
- A-010: 未実施 / 実ブラウザで該当画面・該当項目を手順通り完全検証できていないため未実施。前回の静的確認を合格扱いするのは不適切と判断し訂正。
- A-011: 未実施 / 実ブラウザで該当画面・該当項目を手順通り完全検証できていないため未実施。前回の静的確認を合格扱いするのは不適切と判断し訂正。
- A-012: 未実施 / 実ブラウザで該当画面・該当項目を手順通り完全検証できていないため未実施。前回の静的確認を合格扱いするのは不適切と判断し訂正。
- A-021: 未実施 / 実ブラウザで該当画面・該当項目を手順通り完全検証できていないため未実施。前回の静的確認を合格扱いするのは不適切と判断し訂正。
- A-022: 未実施 / 実ブラウザで該当画面・該当項目を手順通り完全検証できていないため未実施。前回の静的確認を合格扱いするのは不適切と判断し訂正。
- A-024: 未実施 / 実ブラウザで該当画面・該当項目を手順通り完全検証できていないため未実施。前回の静的確認を合格扱いするのは不適切と判断し訂正。
- A-026: 未実施 / 実ブラウザで該当画面・該当項目を手順通り完全検証できていないため未実施。前回の静的確認を合格扱いするのは不適切と判断し訂正。
- A-035: 未実施 / 実ブラウザで該当画面・該当項目を手順通り完全検証できていないため未実施。前回の静的確認を合格扱いするのは不適切と判断し訂正。
- A-036: 未実施 / 実ブラウザで該当画面・該当項目を手順通り完全検証できていないため未実施。前回の静的確認を合格扱いするのは不適切と判断し訂正。
- A-038: 未実施 / 実ブラウザで該当画面・該当項目を手順通り完全検証できていないため未実施。前回の静的確認を合格扱いするのは不適切と判断し訂正。
- A-040: 未実施 / 実ブラウザで該当画面・該当項目を手順通り完全検証できていないため未実施。前回の静的確認を合格扱いするのは不適切と判断し訂正。
- A-052: 未実施 / 実ブラウザで該当画面・該当項目を手順通り完全検証できていないため未実施。前回の静的確認を合格扱いするのは不適切と判断し訂正。
- A-053: 未実施 / 実ブラウザで該当画面・該当項目を手順通り完全検証できていないため未実施。前回の静的確認を合格扱いするのは不適切と判断し訂正。
- A-057: 未実施 / 実ブラウザで該当画面・該当項目を手順通り完全検証できていないため未実施。前回の静的確認を合格扱いするのは不適切と判断し訂正。
- A-058: 未実施 / 実ブラウザで該当画面・該当項目を手順通り完全検証できていないため未実施。前回の静的確認を合格扱いするのは不適切と判断し訂正。
- A-059: 未実施 / 実ブラウザで該当画面・該当項目を手順通り完全検証できていないため未実施。前回の静的確認を合格扱いするのは不適切と判断し訂正。
- A-061: 未実施 / 実ブラウザで該当画面・該当項目を手順通り完全検証できていないため未実施。前回の静的確認を合格扱いするのは不適切と判断し訂正。
- A-062: 未実施 / 実ブラウザで該当画面・該当項目を手順通り完全検証できていないため未実施。前回の静的確認を合格扱いするのは不適切と判断し訂正。
- A-063: 未実施 / 実ブラウザで該当画面・該当項目を手順通り完全検証できていないため未実施。前回の静的確認を合格扱いするのは不適切と判断し訂正。
- A-072: 未実施 / 実ブラウザで該当画面・該当項目を手順通り完全検証できていないため未実施。前回の静的確認を合格扱いするのは不適切と判断し訂正。
- A-073: 未実施 / 実ブラウザで該当画面・該当項目を手順通り完全検証できていないため未実施。前回の静的確認を合格扱いするのは不適切と判断し訂正。
- A-075: 未実施 / 実ブラウザで該当画面・該当項目を手順通り完全検証できていないため未実施。前回の静的確認を合格扱いするのは不適切と判断し訂正。
- A-077: 未実施 / 実ブラウザで該当画面・該当項目を手順通り完全検証できていないため未実施。前回の静的確認を合格扱いするのは不適切と判断し訂正。
- A-086: 未実施 / 実ブラウザで該当画面・該当項目を手順通り完全検証できていないため未実施。前回の静的確認を合格扱いするのは不適切と判断し訂正。
...
- A-201: 未実施 / ソース基準: CodePage=932 / Session.CodePage=932 / meta charset=shift_jis を追加済み。表示証拠: 
- A-213: 未実施 / ソース基準: CodePage=932 / Session.CodePage=932 / meta charset=shift_jis あり。表示確認は要ログインのため未実施。
- A-227: 未実施 / ソース基準: CodePage=932 / Session.CodePage=932 / meta charset=shift_jis あり。表示確認は要ログインのため未実施。
- A-241: 未実施 / ソース基準: CodePage=932 / Session.CodePage=932 / meta charset=shift_jis を追加済み。表示確認は要ログインのため未実施。
- A-252: 未実施 / ソース基準: CodePage=932 / Session.CodePage=932 / meta charset=shift_jis を追加済み。表示証拠: 
- A-264: 未実施 / ソース基準: CodePage=932 / Session.CodePage=932 / meta charset=shift_jis あり。表示確認は要ログインのため未実施。
- A-278: 未実施 / ソース基準: CodePage=932 / Session.CodePage=932 / meta charset=shift_jis あり。表示確認は要ログインのため未実施。
- A-292: 未実施 / ソース基準: CodePage=932 / Session.CodePage=932 / meta charset=shift_jis を追加済み。表示確認は要ログインのため未実施。
- A-303: 未実施 / ソース基準: CodePage=932 / Session.CodePage=932 / meta charset=shift_jis を追加済み。表示証拠: 
- A-315: 未実施 / ソース基準: CodePage=932 / Session.CodePage=932 / meta charset=shift_jis あり。表示確認は要ログインのため未実施。
- A-329: 未実施 / ソース基準: CodePage=932 / Session.CodePage=932 / meta charset=shift_jis あり。表示確認は要ログインのため未実施。
- A-343: 未実施 / ソース基準: CodePage=932 / Session.CodePage=932 / meta charset=shift_jis を追加済み。表示確認は要ログインのため未実施。
- A-354: 未実施 / ソース基準: CodePage=932 / Session.CodePage=932 / meta charset=shift_jis を追加済み。表示証拠: 
- C1-01: 未実施 / current account uid=3070 has 2 reservable courses (61, 77). C1-01 is not reproducible with current account. evidence: uid_course_probe.asp / remaining_case_probe_20260617.txt
- C1-02: 未実施 / current account uid=3070 has 2 reservable courses (61, 77). C1-02 is not reproducible with current account. evidence: uid_course_probe.asp / remaining_case_probe_20260617.txt
- C2-02: 未実施 / runtime evidence shows current account remaining count is 17, not 0. C2-02 is not reproducible with current account. evidence: runtime_regression_notes_20260615.txt / remaining_case_probe_20260617.txt
- C2-06: 未実施 / 現行アカウントでは CourseType=1 の予約済み UI 証跡を取得できず未実施。course 77 は予約済み対象データがそろわず、course 61 は CourseType=2。evidence: C2_06_main_chrome_20260617.png / teacher_join_probe.asp / scenario_probe.asp / chrome_c1_c2_probe_20260617.json
- C2-07: 保留 / CourseType=2 セッションでキャンセル一覧を表示したところ、時刻は出るが text_name / lesson_name は空欄だった。改修起因の不具合とは断定せず、対象マスタデータ不足による LEFT JOIN 結果空欄として保留扱い。evidence: C2_main_after_reserve_20260615.png / runtime_regression_notes_20260615.txt
- C2-08: 未実施 / current account reserved lesson is 2026-06-29 12:00 and is not past cancel deadline as of 2026-06-17. C2-08 is not reproducible with current account. evidence: scenario_probe.asp / remaining_case_probe_20260617.txt
- C3-04: 保留 / calendar.js 上で canow 付与ロジックは確認したが、実画面の当日セル証跡が無いため保留。
- C3-05: 保留 / calendar.js 上でうるう年判定ロジックは確認したが、2/29 の実画面証跡が無いため保留。
- C3-08: 未実施 / probe on current account / future data found no total=0 class. C3-08 is not reproducible with current account. evidence: scenario_probe.asp / remaining_case_probe_20260617.txt
- C3-09: 未実施 / probe on current account / future data found no closed class. C3-09 is not reproducible with current account. evidence: scenario_probe.asp / remaining_case_probe_20260617.txt
- C3-11: 未実施 / probe on current account / future data found no overlapping class. C3-11 is not reproducible with current account. evidence: scenario_probe.asp / remaining_case_probe_20260617.txt
- C3-14: 保留 / ChkSecXss 経由のコード確認はできたが、特殊文字を含む実データ表示証跡が無いため保留。
- C4-01: 保留 / error.asp?Message=... の表示確認メモはあるが、提出用スクリーンショット証跡が残っていないため保留。
- C4-02: 保留 / error.asp の戻る/閉じるのコード確認はあるが、提出用の操作証跡が無いため保留。
